...
execute if score @s fl_direction matches 1 run summon glow_item_frame ~ ~ ~-1 {CustomNameVisible:0b,Facing:1b,ItemRotation:0b,Invulnerable:1b,Invisible:1b,Fixed:1b,Silent:1b,Tags:["motor_block","motor_init","custom_block"],Item:{id:"minecraft:structure_void",Count:1b,tag:{CustomModelData:3111002}}}
execute if score @s fl_direction matches 2 run summon glow_item_frame ~-1 ~ ~ {CustomNameVisible:0b,Facing:1b,ItemRotation:0b,Invulnerable:1b,Invisible:1b,Fixed:1b,Silent:1b,Tags:["motor_block","motor_init","custom_block"],Item:{id:"minecraft:structure_void",Count:1b,tag:{CustomModelData:3111002}}}
execute if score @s fl_direction matches 3 run summon glow_item_frame ~1 ~ ~ {CustomNameVisible:0b,Facing:1b,ItemRotation:0b,Invulnerable:1b,Invisible:1b,Fixed:1b,Silent:1b,Tags:["motor_block","motor_init","custom_block"],Item:{id:"minecraft:structure_void",Count:1b,tag:{CustomModelData:3111002}}}
execute if score @s fl_direction matches 4 run summon glow_item_frame ~ ~ ~1 {CustomNameVisible:0b,Facing:1b,ItemRotation:0b,Invulnerable:1b,Invisible:1b,Fixed:1b,Silent:1b,Tags:["motor_block","motor_init","custom_block"],Item:{id:"minecraft:structure_void",Count:1b,tag:{CustomModelData:3111002}}}
