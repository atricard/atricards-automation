...
execute as @s[y_rotation=-135..-45] positioned ~ ~-1 ~ if entity @e[type=marker,tag=ship_marker,distance=..1] at @s run teleport @s ~1 ~ ~
execute as @s[y_rotation=-45..44] positioned ~ ~-1 ~ if entity @e[type=marker,tag=ship_marker,distance=..1] at @s run teleport @s ~ ~ ~1
execute as @s[y_rotation=45..134] positioned ~ ~-1 ~ if entity @e[type=marker,tag=ship_marker,distance=..1] at @s run teleport @s ~-1 ~ ~
execute as @s[y_rotation=135..-134] positioned ~ ~-1 ~ if entity @e[type=marker,tag=ship_marker,distance=..1] at @s run teleport @s ~ ~ ~-1
