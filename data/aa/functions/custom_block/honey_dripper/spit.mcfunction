...
#
execute if block ~ ~ ~ dropper[facing=up]{Items:[{Slot:3b}]} unless data block ~ ~ ~ Items[{Slot:3b}].tag.gui run summon item ~ ~1 ~ {PickupDelay:10s,Item:{id:"minecraft:stick",Count:1b},Tags:["wrong_slot"]}
execute if block ~ ~ ~ dropper[facing=up]{Items:[{Slot:3b}]} unless data block ~ ~ ~ Items[{Slot:3b}].tag.gui run data modify entity @e[type=item,tag=wrong_slot,limit=1,sort=nearest] Item.id set from block ~ ~ ~ Items[{Slot:3b}].id
execute if block ~ ~ ~ dropper[facing=up]{Items:[{Slot:3b}]} unless data block ~ ~ ~ Items[{Slot:3b}].tag.gui run data modify entity @e[type=item,tag=wrong_slot,limit=1,sort=nearest] Item.Count set from block ~ ~ ~ Items[{Slot:3b}].Count
execute if block ~ ~ ~ dropper[facing=up]{Items:[{Slot:3b}]} unless data block ~ ~ ~ Items[{Slot:3b}].tag.gui run data modify entity @e[type=item,tag=wrong_slot,limit=1,sort=nearest] Item.tag set from block ~ ~ ~ Items[{Slot:3b}].tag
#
execute if block ~ ~ ~ dropper[facing=up]{Items:[{Slot:4b}]} run summon item ~ ~1 ~ {PickupDelay:10s,Item:{id:"minecraft:stick",Count:1b},Tags:["wrong_slot"]}
execute if block ~ ~ ~ dropper[facing=up]{Items:[{Slot:4b}]} run data modify entity @e[type=item,tag=wrong_slot,limit=1,sort=nearest] Item.id set from block ~ ~ ~ Items[{Slot:4b}].id
execute if block ~ ~ ~ dropper[facing=up]{Items:[{Slot:4b}]} run data modify entity @e[type=item,tag=wrong_slot,limit=1,sort=nearest] Item.Count set from block ~ ~ ~ Items[{Slot:4b}].Count
execute if block ~ ~ ~ dropper[facing=up]{Items:[{Slot:4b}]} run data modify entity @e[type=item,tag=wrong_slot,limit=1,sort=nearest] Item.tag set from block ~ ~ ~ Items[{Slot:4b}].tag
#
