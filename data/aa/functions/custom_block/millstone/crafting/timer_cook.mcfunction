...
execute if score @s output_count matches 0 if score @s input_diamond_count matches 1.. run scoreboard players add @s cook_time 1
#
...
execute if score @s output_count matches ..63 if score @s input_diamond_count matches 1.. if data block ~ ~ ~ {Items:[{id:"minecraft:structure_void",Slot:7b,tag:{display:{Name:'{"text":"Diamond Dust","italic":false,"color":"white"}'},CustomModelData:3112001}}]} run scoreboard players add @s cook_time 1
