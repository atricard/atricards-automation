...
execute unless block ~ ~ ~ barrel[facing=down]{Items:[{id:"minecraft:axolotl_spawn_egg",Slot:5b,tag:{gui:1b}}]} run scoreboard players set @s recipe_id 4
execute unless block ~ ~ ~ barrel[facing=down]{Items:[{id:"minecraft:axolotl_spawn_egg",Slot:11b,tag:{gui:1b}}]} run scoreboard players set @s recipe_id 5
execute unless block ~ ~ ~ barrel[facing=down]{Items:[{id:"minecraft:axolotl_spawn_egg",Slot:12b,tag:{gui:1b}}]} run scoreboard players set @s recipe_id 6
execute unless block ~ ~ ~ barrel[facing=down]{Items:[{id:"minecraft:axolotl_spawn_egg",Slot:13b,tag:{gui:1b}}]} run scoreboard players set @s recipe_id 7
execute unless block ~ ~ ~ barrel[facing=down]{Items:[{id:"minecraft:axolotl_spawn_egg",Slot:14b,tag:{gui:1b}}]} run scoreboard players set @s recipe_id 8
execute unless block ~ ~ ~ barrel[facing=down]{Items:[{id:"minecraft:axolotl_spawn_egg",Slot:20b,tag:{gui:1b}}]} run scoreboard players set @s recipe_id 9
