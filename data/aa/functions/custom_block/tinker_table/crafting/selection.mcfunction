...
execute if block ~ ~ ~ barrel[facing=down]{Items:[{Slot:17b}]} unless block ~ ~ ~ barrel[facing=down]{Items:[{id:"minecraft:axolotl_spawn_egg",Slot:5b,tag:{gui:1b}}]} run function aa:custom_block/tinker_table/crafting/spit_output
execute if block ~ ~ ~ barrel[facing=down]{Items:[{Slot:17b}]} unless block ~ ~ ~ barrel[facing=down]{Items:[{id:"minecraft:axolotl_spawn_egg",Slot:11b,tag:{gui:1b}}]} run function aa:custom_block/tinker_table/crafting/spit_output
execute if block ~ ~ ~ barrel[facing=down]{Items:[{Slot:17b}]} unless block ~ ~ ~ barrel[facing=down]{Items:[{id:"minecraft:axolotl_spawn_egg",Slot:12b,tag:{gui:1b}}]} run function aa:custom_block/tinker_table/crafting/spit_output
execute if block ~ ~ ~ barrel[facing=down]{Items:[{Slot:17b}]} unless block ~ ~ ~ barrel[facing=down]{Items:[{id:"minecraft:axolotl_spawn_egg",Slot:13b,tag:{gui:1b}}]} run function aa:custom_block/tinker_table/crafting/spit_output
execute if block ~ ~ ~ barrel[facing=down]{Items:[{Slot:17b}]} unless block ~ ~ ~ barrel[facing=down]{Items:[{id:"minecraft:axolotl_spawn_egg",Slot:14b,tag:{gui:1b}}]} run function aa:custom_block/tinker_table/crafting/spit_output
execute if block ~ ~ ~ barrel[facing=down]{Items:[{Slot:17b}]} unless block ~ ~ ~ barrel[facing=down]{Items:[{id:"minecraft:axolotl_spawn_egg",Slot:20b,tag:{gui:1b}}]} run function aa:custom_block/tinker_table/crafting/spit_output
...
#
execute unless block ~ ~ ~ barrel[facing=down]{Items:[{id:"minecraft:structure_void",Slot:6b,tag:{gui:1b}}]} run scoreboard players set @s tt_recipe_id 0
execute unless block ~ ~ ~ barrel[facing=down]{Items:[{id:"minecraft:structure_void",Slot:15b,tag:{gui:1b}}]} run scoreboard players set @s tt_recipe_id 0
execute unless block ~ ~ ~ barrel[facing=down]{Items:[{id:"minecraft:structure_void",Slot:24b,tag:{gui:1b}}]} run scoreboard players set @s tt_recipe_id 0
...
execute unless block ~ ~ ~ barrel[facing=down]{Items:[{id:"minecraft:axolotl_spawn_egg",Slot:22b,tag:{gui:1b}}]} run scoreboard players set @s tt_recipe_id 11
execute unless block ~ ~ ~ barrel[facing=down]{Items:[{id:"minecraft:carrot_on_a_stick",Slot:23b,tag:{gui:1b}}]} run scoreboard players set @s tt_recipe_id 12
