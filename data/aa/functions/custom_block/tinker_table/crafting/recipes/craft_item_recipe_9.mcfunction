...
item replace block ~ ~ ~ container.17 with axolotl_spawn_egg{display:{Name:'{"text":"Honey Dripper","italic":false}'},CustomModelData:3110000,EntityTag:{id:"minecraft:area_effect_cloud",Duration:1,Radius:0f,Age:1,Tags:["dripper","empires_machine","machine_init"]}} 1