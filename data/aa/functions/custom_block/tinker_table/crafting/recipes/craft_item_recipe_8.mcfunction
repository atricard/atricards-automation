...
item replace block ~ ~ ~ container.17 with axolotl_spawn_egg{display:{Name:'{"text":"Millstone","italic":false}'},CustomModelData:2910000,EntityTag:{id:"minecraft:area_effect_cloud",Duration:1,Radius:0f,Age:1,Tags:["millstone","empires_machine","machine_init"]}} 1