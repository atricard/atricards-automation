...
item replace block ~ ~ ~ container.17 with axolotl_spawn_egg{display:{Name:'{"text":"Sprinkler","italic":false}'},CustomModelData:2300002,EntityTag:{id:"minecraft:area_effect_cloud",Duration:1,Radius:0f,Age:1,Tags:["sprinkler","empires_machine","machine_init"]}} 1