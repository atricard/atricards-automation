...
item replace block ~ ~ ~ container.17 with axolotl_spawn_egg{display:{Name:'{"text":"Diamond-tipped Sawmill","italic":false}'},CustomModelData:3112000,EntityTag:{id:"minecraft:area_effect_cloud",Duration:1,Radius:0f,Age:1,Tags:["saw","aa_block","aa_block_init"]}} 1