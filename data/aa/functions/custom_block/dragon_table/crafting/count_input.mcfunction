execute store result score @s input_dragon_scale_count run data get block ~ ~ ~ Items[{Slot:0b,id:"minecraft:axolotl_spawn_egg",tag:{display:{Name:'{"text":"Dragon Scale Block","italic":false,"color":"yellow"}'},CustomModelData:3111004,EntityTag:{id:"minecraft:area_effect_cloud",Duration:1,Radius:0f,Age:1,Tags:["scale","aa_block","aa_block_init"]}}}].Count 1
execute store result score @s input_glass_count run data get block ~ ~ ~ Items[{Slot:6b,id:"minecraft:glass"}].Count 1
