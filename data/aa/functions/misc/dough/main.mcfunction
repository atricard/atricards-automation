...
execute if score @s dough_cook_time matches 400.. run data merge entity @s {Item:{id:"minecraft:bread"}}
execute if score @s dough_cook_time matches 400.. run data remove entity @s Item.tag.display
execute if score @s dough_cook_time matches 400.. run data remove entity @s Item.tag.CustomModelData
