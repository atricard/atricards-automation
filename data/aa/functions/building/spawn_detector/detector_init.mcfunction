execute if entity @e[type=marker,tag=building_detector,tag=!detector_init,distance=..12] run function aa:building/spawn_detector/break
execute positioned ~-16 -65 ~-16 unless entity @e[type=marker,tag=plot,tag=bought,dx=32,dy=320,dz=32] at @s run function aa:building/spawn_detector/break
#Set block counts
