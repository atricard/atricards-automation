...
execute unless block ~ ~-1 ~ water unless block ~ ~ ~ seagrass unless block ~ ~ ~ tall_seagrass unless block ~ ~ ~ kelp unless block ~ ~ ~ kelp_plant run function empires:custom_mob/clam/spawn
