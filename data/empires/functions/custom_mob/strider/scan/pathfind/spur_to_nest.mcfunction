summon area_effect_cloud ~ ~1 ~ {Tags:["nest_spur"],Age:-1,WaitTime:-1,Radius:0.5f,Duration:2,DurationOnUse:-2,Effects:[{Id:6b,Amplifier:255,Duration:1,ShowParticles:0b}]}
