...
#25      Warehouse - Chest
execute if score @s building_id matches 1 run tag @s add b_home
#execute if score @s building_id matches 2..5 run tag @s add b_job
execute if score @s building_id matches 6 run tag @s add b_meet
#execute if score @s building_id matches 7 run tag @s add b_job
execute if score @s building_id matches 8 run tag @s add b_meet
#execute if score @s building_id matches 9..15 run tag @s add b_job
execute if score @s building_id matches 16 run tag @s add b_meet
#execute if score @s building_id matches 17..24 run tag @s add b_job
