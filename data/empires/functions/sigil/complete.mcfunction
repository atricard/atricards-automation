...
execute if entity @s[tag=!complete] run tellraw @a[distance=..15] {"text":"To finalize the building, a Bulletin must be placed near it.\nAfter Bulletins have been placed, they cannot be picked up.","color":"green"}
tag @s add complete
