...
#store
execute if score @s stored_water matches 1.. if score @s stored_lava matches 1.. run function empires:custom_block/tank/store/harden
execute if score @s stored_water matches 9.. positioned ~ ~1 ~ if entity @e[type=glow_item_frame,tag=tank_block,distance=..0.5] run function empires:custom_block/tank/store/fill_water
execute if score @s stored_lava matches 9.. positioned ~ ~1 ~ if entity @e[type=glow_item_frame,tag=tank_block,distance=..0.5] run function empires:custom_block/tank/store/fill_lava
#
execute if score @s stored_water matches 1.. positioned ~ ~-1 ~ as @e[type=glow_item_frame,tag=tank_block,distance=..0.5,sort=nearest,limit=1] if score @s stored_water matches ..7 run function empires:custom_block/tank/store/sink_water
execute if score @s stored_lava matches 1.. positioned ~ ~-1 ~ as @e[type=glow_item_frame,tag=tank_block,distance=..0.5,sort=nearest,limit=1] if score @s stored_lava matches ..7 run function empires:custom_block/tank/store/sink_lava
#burst
execute if score @s stored_water matches 9.. positioned ~ ~1 ~ unless entity @e[type=glow_item_frame,tag=tank_block,distance=..0.5] run function empires:custom_block/tank/store/burst_water
execute if score @s stored_lava matches 9.. positioned ~ ~1 ~ unless entity @e[type=glow_item_frame,tag=tank_block,distance=..0.5] run function empires:custom_block/tank/store/burst_lava
#visual water
