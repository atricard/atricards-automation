...
execute unless entity @e[type=item,distance=..5,nbt={Item:{tag:{pearl:1b}}}] run summon item ~ ~ ~ {Age:5800,PickupDelay:20s,Motion:[0.0,0.15,0.0],Item:{id:"structure_void",Count:1b,tag:{display:{Name:'{"text":"Pearl","italic":false}'},CustomModelData:2700002,pearl:1b}}}
