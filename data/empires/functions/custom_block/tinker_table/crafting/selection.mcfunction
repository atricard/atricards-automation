...
execute if block ~ ~ ~ barrel[facing=down]{Items:[{Slot:16b}]} unless block ~ ~ ~ barrel[facing=down]{Items:[{id:"minecraft:axolotl_spawn_egg",Slot:14b,tag:{gui:1b}}]} run function empires:custom_block/tinker_table/crafting/spit_output
#
