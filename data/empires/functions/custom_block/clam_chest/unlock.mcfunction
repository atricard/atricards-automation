data remove storage empires:clam_lock key_name
data modify storage empires:clam_lock key_name set from entity @p[distance=..5] SelectedItem.tag.display.Name
execute store result score @s key_check run data modify storage empires:clam_lock key_name set from entity @s CustomName
