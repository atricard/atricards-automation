execute unless block ~ ~ ~ #empires:fluid run summon item ~ ~ ~ {Motion:[0.0,0.25,0.0],Item:{id:"minecraft:slime_spawn_egg",Count:1b,tag:{display:{Name:'{"text":"Village Storage","italic":false}'},Enchantments:[{}],EntityTag:{id:"minecraft:area_effect_cloud",Duration:1,Tags:["storage","empires_machine","machine_init"]}}}}
