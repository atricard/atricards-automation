...
execute if score @s pipe_rotation matches 1 run summon glow_item_frame ~ ~ ~ {CustomNameVisible:0b,Facing:1b,ItemRotation:0b,Invulnerable:1b,Invisible:1b,Fixed:1b,Tags:["sprinkler_block","fluid_block","custom_block","pipe_stuck"],Item:{id:"minecraft:structure_void",Count:1b,tag:{CustomModelData:2300002}}}
#pling
