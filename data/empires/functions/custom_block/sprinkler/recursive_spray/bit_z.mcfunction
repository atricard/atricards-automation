...
execute if predicate empires:spray_chance run function empires:custom_block/sprinkler/recursive_spray/bone_meal
#recurse
scoreboard players add $z spray_scan 1
execute if score $z spray_scan matches 0..4 positioned ~ ~ ~1 run function empires:custom_block/sprinkler/recursive_spray/bit_z