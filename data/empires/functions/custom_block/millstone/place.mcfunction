execute unless block ~ ~ ~ #empires:fluid run summon item ~ ~ ~ {Motion:[0.0,0.15,0.0],Item:{id:"axolotl_spawn_egg",Count:1b,tag:{display:{Name:'{"text":"Millstone","italic":false}'},CustomModelData:2910000,EntityTag:{id:"minecraft:area_effect_cloud",Duration:1,Radius:0f,Age:1,Tags:["millstone","empires_machine","machine_init"]}}}}
...
execute as @s[tag=machine_init,tag=valid_machine_place] run setblock ~ ~ ~ dropper[facing=up]{CustomName:'[{"text":"  Millstone"},{"translate":"space.-48","font":"space:default"},{"translate":"\\uE020","font":"space:default","color":"white"}]'} replace
